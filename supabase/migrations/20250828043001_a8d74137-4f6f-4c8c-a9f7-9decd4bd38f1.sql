...
ADD COLUMN bundle_product_ids TEXT[] DEFAULT '{}',
ADD COLUMN bundle_discount_amount NUMERIC DEFAULT 0,
ADD COLUMN bundle_discount_percentage NUMERIC DEFAULT 0;
...
ALTER TABLE product_schemes 
ADD COLUMN free_product_id UUID REFERENCES products(id),
ADD COLUMN buy_quantity INTEGER DEFAULT 0;
...
-- Update existing scheme_type to support new values
