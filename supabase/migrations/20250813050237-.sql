...
-- Prevent admins from updating profiles directly - they must use specific functions
-- Remove general admin update policy entirely to force use of secure functions

-- Add explicit policy to prevent access to sensitive fields
