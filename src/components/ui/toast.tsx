...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-3 top-3 rounded-full p-1.5 text-foreground/80 hover:text-foreground bg-background hover:bg-muted shadow-lg border-2 border-border transition-all focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring group-[.destructive]:text-white group-[.destructive]:hover:text-white group-[.destructive]:bg-destructive-foreground/20 group-[.destructive]:hover:bg-destructive-foreground/40 group-[.destructive]:border-destructive-foreground/50",
      className
    )}
    toast-close=""
    {...props}
