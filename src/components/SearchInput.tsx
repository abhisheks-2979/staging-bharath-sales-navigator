  ...
  return (
    <div className="relative mb-2 sm:mb-4">
      ...
      <Input
        ...
        className="pl-8 sm:pl-10 bg-gradient-to-r from-primary/5 to-primary/10 border border-primary/20 focus:border-primary focus:ring-primary/30 text-sm sm:text-base font-medium placeholder:text-muted-foreground shadow-lg backdrop-blur-sm"
      />
