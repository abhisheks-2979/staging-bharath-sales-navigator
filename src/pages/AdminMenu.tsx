...
import { Shield, Users, Settings, Package, Calendar, UserPlus, ArrowLeft } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Access all administrative functions</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Access main administrative controls and settings
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Manage products, SKUs, and schemes
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Manage company holidays and schedules
              </CardDescription>
            </CardHeader>
          </Card>
